                    ...
                    <div class="card card-block sameheight-item">
                        ...
                        <form role="form" enctype="multipart/form-data" method="POST" action="{{ url('product/products/edit', ['id' => $product->id]) }}" novalidate>
                            ...
                            <div class="form-group{{ $errors->has('unit_price') ? ' has-error' : '' }}">
                                ...
                                {{ Form::text('unit_price', trim($product->cost->unit_price), ['class' => 'form-control underlined', 'placeholder' => 'Precio unitario', 'id' => 'unit-price']) }}
...
<!--                                       $message = "wrong answer";
        echo "<script type='text/javascript'>alert($unit-cost)</script>";
        echo "hola";  -->
