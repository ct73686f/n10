        ...
        <section class="section">
            <div class="row sameheight-container">
                <div class="col-md-10 offset-md-1">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group{{ $errors->has('nit') ? ' has-error' : '' }}">
                                    <label for="nit" class="control-label">Código</label>
                                    {{ Form::text('nit', 'CF', ['class' => 'form-control underlined', 'placeholder' => 'Código', 'id' => 'nit']) }}
                    ...
                    <div class="card card-block" id="payment-block" style="display: none;">
                        <div class="title-block">
                    ...
                    <div class="card card-block" id="details-block" style="display: none;">
                        ...
                        <form id="invoice-form" role="form" method="POST" action="{{ url('product/movements/new') }}"
                            ...
                            <input type="hidden" id="invoice-wholesale" name="wholesale_apply">
...
@section('page-script')
    <script>
        $(function () {
            ...
            var $invoiceWholesale    = $('#invoice-wholesale');
            var $product             = $('#product');
            var productCount         = 0;
            var productsTotal        = [];
            var productObjects       = [];
                            ...
                            $.ajax({
                                ...
                                success: function (prodres) {
                                    if (prodres.valid) {
                                        ...
                                        var inputProduct = $('<input type="hidden" name="product[]" value="' + product + '"><input type="hidden" name="quantity[]" value="' + $quantity.val() + '">');
